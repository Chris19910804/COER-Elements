...
export class CoerGridPage extends Page { 
    ...
    items: any = [
        { id: 0, name: 'batman', icon: 'fa-solid fa-book', isActive: true, module: '', submodule: '' },
        { id: 1, name: 'superman', icon: '', isActive: false, module: '', submodule: '' },
        { id: 2, name: 'spiderman', icon: 'bi bi-record-fill', isActive: true, module: '', submodule: '' },
        { id: 3, name: 'iroman', icon: '', isActive: false, module: '', submodule: '' },
        { id: 4, name: 'hulk', icon: 'bi bi-record-fill', isActive: true, module: '', submodule: '' },
    ...
    protected template = (item: any): string => {     
        return Tools.IsNotOnlyWhiteSpace(item?.value) 
            ? `<i class='${item.value} w-100 text-center'></i>`
